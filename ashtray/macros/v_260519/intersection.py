...
# def add_enumurate_number(comp_obj, is_upper: False, font, text_height):
def add_enumurate_number(comp_obj, font, text_height):
    ...
    for num, face in enumerate(comp_obj.Faces, start=1):
        ...
        text_move_placement = App.Placement(
            App.Vector(-x_offset + com.x, -y_offset + com.y, com.z + 0.01),
            App.Rotation(),
        )
...
def intersection(
    ...
    enum_x_faces_0 = add_enumurate_number(
        x_slotted_0, dxf_settings.font_path, dxf_settings.text_height
    )
    enum_y_faces_0 = add_enumurate_number(
        y_slotted_0, dxf_settings.font_path, dxf_settings.text_height
    )
    ...
    enum_x_faces_1 = add_enumurate_number(
        x_slotted_1, dxf_settings.font_path, dxf_settings.text_height
    )
    enum_y_faces_1 = add_enumurate_number(
        y_slotted_1, dxf_settings.font_path, dxf_settings.text_height
    )
