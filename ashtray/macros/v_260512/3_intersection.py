...
def create_offset_faces(
    shape, sheets: sheet_info, offset_to_outside=True, as_compound=False
):
    interval = sheets.interval + sheets.thickness + sheets.thick_gap
    offsets = []
...
def main():
    ...
    x_lower_offset = -consts.cube_z_offset / 2 - consts.thick_gap / 2
    ...
    aligned_comp_sheets = arrange_faces_y(comp_sheets_list, gap=consts.dxf_sheets_gap)
